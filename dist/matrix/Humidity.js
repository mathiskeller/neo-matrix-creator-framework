...
function (_EventEmitter) {
  (0, _inherits2.default)(Humidity, _EventEmitter);

  function Humidity(options) {
    var _this;

    (0, _classCallCheck2.default)(this, Humidity);
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(Humidity).call(this));
    var defaults = {
      name: 'HUMIDITY',
    ...
    var driverConfig = matrixIo.malos.v1.driver.DriverConfig.create({
      ...
      humidity: matrixIo.malos.v1.sense.HumidityParams.create({
        currentTemperature: _this.options.calibrationTemperature
      })
    });
  ...
  (0, _createClass2.default)(Humidity, [{
    key: "update",
    value: function update() {
      ...
      updateSocket.on('message', function (buffer) {
        var data = matrixIo.malos.v1.sense.Humidity.decode(buffer);
