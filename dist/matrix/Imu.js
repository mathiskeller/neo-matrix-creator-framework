...
function (_EventEmitter) {
  (0, _inherits2.default)(Imu, _EventEmitter);

  function Imu(options) {
    var _this;

    (0, _classCallCheck2.default)(this, Imu);
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(Imu).call(this));
    var defaults = {
      name: 'IMU',
  ...
  (0, _createClass2.default)(Imu, [{
    ...
    value: function update() {
      ...
      updateSocket.on('message', function (buffer) {
        var data = matrixIo.malos.v1.sense.Imu.decode(buffer);
