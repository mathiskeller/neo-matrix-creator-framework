...
function (_EventEmitter) {
  (0, _inherits2.default)(Pressure, _EventEmitter);

  function Pressure(options) {
    var _this;

    (0, _classCallCheck2.default)(this, Pressure);
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(Pressure).call(this));
    var defaults = {
      name: 'PRESSURE',
  ...
  (0, _createClass2.default)(Pressure, [{
    key: "update",
    value: function update() {
      ...
      updateSocket.on('message', function (buffer) {
        var data = matrixIo.malos.v1.sense.Pressure.decode(buffer);
